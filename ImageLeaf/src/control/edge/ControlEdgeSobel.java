...
import view.edge.ViewEdgeSobel;
 ...
 * @author anderson
 */
public class ControlEdgeSobel {

    private viewPrincipal parentFrame = null;
    private ViewEdgeSobel view = null;
    private BufferedImage image = null;
    private BufferedImage filterImage = null;

    public ControlEdgeSobel(BufferedImage image, viewPrincipal parentFrame) {
        this.image = image;
        this.parentFrame = parentFrame;
        view = new ViewEdgeSobel();
